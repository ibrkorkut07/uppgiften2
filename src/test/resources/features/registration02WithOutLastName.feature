...
Feature: Basketball England New Supporter Registration
  ...
  @validation @chrome
  Scenario Outline: Registration without last name
    When Enter valid "<dateOfBirth>", "<firstName>", "<email>", "<confirmEmail>", "<password>", "<confirmPassword>" registration details:
    ...
    Examples:
      | dateOfBirth | firstName | email                 | confirmEmail          | password | confirmPassword |
      | 01/11/2004  | Jame     | jame.smithy@test.com | jame.smithy@test.com | Pass12b! | Pass12b!        |
